    ...
    <div className="min-h-screen bg-[#14284a] flex flex-col font-body text-[#0a192f]">
      ...
      <div className="bg-[#0a192f] px-6 md:px-12 sticky top-0 z-40 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          <div className="mb-3 text-xs uppercase tracking-[0.35em] text-slate-500 font-semibold">
            Choose your application type
          </div>
          <div className="flex gap-3 bg-slate-50 rounded-xl p-2 shadow-sm border border-slate-200" style={{ backgroundColor: '#f8fafc', borderColor: '#cbd5e1', boxShadow: '0 18px 45px rgba(15, 23, 42, 0.08)' }}>
            <button
              ...
              style={
                data.type === 'personal'
                  ? {
                      backgroundColor: '#c29d45',
                      color: '#ffffff',
                      fontSize: '1rem',
                      fontWeight: 700,
                      letterSpacing: '0.08em',
                      border: '1px solid #c29d45',
                      padding: '1rem 1.5rem',
                      boxShadow: '0 18px 40px rgba(194, 157, 69, 0.2)',
                      minWidth: '170px',
                    }
                  : {
