...
export const PERSONAL_STEPS: FormStep[] = [
  ...
  },
  {
    ...
    order: 7,
    title: "FEE BANK",
    description: "Provide referral details separately from the fee payment bank account information.",
    fields: [
      { id: "f38", section: "Referral", label: "Recommended by", name: "referral", type: "text", width: "full" },
      { id: "f39", section: "Information on the bank account from which the fee is being paid (if applicable)", label: "Bank Name", name: "feeBank", type: "text", width: "half" },
      { id: "f40", section: "Information on the bank account from which the fee is being paid (if applicable)", label: "Bank Address", name: "feeBankAddr", type: "text", width: "half" },
      { id: "f41", section: "Information on the bank account from which the fee is being paid (if applicable)", label: "Bank Swift Code", name: "feeSwift", type: "text", width: "half" },
      { id: "f42", section: "Information on the bank account from which the fee is being paid (if applicable)", label: "Account Holder Name", name: "feeAccHolder", type: "text", width: "half" },
      { id: "f43", section: "Information on the bank account from which the fee is being paid (if applicable)", label: "Account Number", name: "feeAccNo", type: "text", width: "half", numericOnly: true },
      { id: "f44", section: "Information on the bank account from which the fee is being paid (if applicable)", label: "Account Signatory Name", name: "feeSignatory", type: "text", width: "half" },
      { id: "f45", section: "Information on the bank account from which the fee is being paid (if applicable)", label: "Describe the Origin of Deposit Funds", name: "feeOrigin", type: "textarea", width: "full" },
    ]
  },
  {
    id: "p8",
